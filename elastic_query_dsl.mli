...
val filter_prefix : string -> term -> query
...
val filter_regexp : string -> term -> query

val filter_wildcard : string -> term -> query

val filter_match : string -> ?operator:[ `And | `Or ] -> term -> query

val filter_match_phrase : string -> term -> query
...
val filter_and : query list -> query option

val filter_or : query list -> query option
